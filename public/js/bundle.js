...
var setAlert = exports.setAlert = function setAlert(message) {
  hideAlert();
  var markup = "<div class=\"alert alert--error\">Something wnet wrong</div>";
...
exports.update_password = exports.update = exports.logout = exports.login = void 0;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(email, password) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          x = res.data.status; //console.log(x);
          if (x == 'success') {
            //console.log(x);
            location.assign('/');
          }
        ...
        case 8:
          ...
          (0, _alerts.setAlert)(_context.t0.response.data.message);
          //console.log(e);
        case 11:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alerts.setAlert)(_context2.t0.response.data.message);
          //console.log(e);
        case 11:
        case "end":
...
var update_password = exports.update_password = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          (0, _alerts.setAlert)(_context3.t0.response.data.message);
          //console.log(e);
        case 11:
        case "end":
  ...
  return function update_password(_x4) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          (0, _alerts.setAlert)('Some error occured. Please try again');
          //console.log(e);
        case 11:
        case "end":
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51P1XmVSJeK18sKEX4HcuEAnVNVTLENUAynXz5B6TeQsMWu1U5jLUn89D6v9SIyKLRexfjbkzQ6Y5LvcfKzGVnmnz003gsBX7nD');
var pay_it = exports.pay_it = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:3000/api/v1/booking/checkout/".concat(tourid)
          });
        case 3:
          ot = _context.sent;
          console.log(ot);
          location.assign("".concat(ot.data.session.url));
          _context.next = 11;
          break;
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.setAlert)(_context.t0);
        case 11:
        case "end":
          return _context.stop();
      }
...
var logou = document.querySelector('.nav__el--logout');
//console.log(logou);
if (logou) {
  logou.addEventListener('click', function (e) {
    (0, _login.logout)();
  });
}
...
var update_frm = document.querySelector('#usr_data');
//console.log(update_frm);
if (update_frm) {
  update_frm.addEventListener('submit', function (e) {
    e.preventDefault();
    var frmc = new FormData();
    ...
    (0, _login.update)(frmc);
  });
}
var pswd_frm = document.querySelector('#user_password');
//console.log(update_frm);
if (pswd_frm) {
  pswd_frm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            confirmnewPassword = document.getElementById('password-confirm').value; // console.log(nam);
            _context.next = 6;
            return (0, _login.update_password)({
...
var pay = document.getElementById('pay_now');
if (pay) {
  pay.addEventListener('click', function (e) {
    (0, _stripe.pay_it)(e.target.dataset.tourId);
  });
}
},{"./login":"login.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
